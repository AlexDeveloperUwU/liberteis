...
function saveEvent(db, title, desc, event_date, type, thumb_url = null, published_by = "Admin") {
...
function editEvent(db, eventID, title, desc, event_date, type, thumb_url = null, qr_url = null, published_by = "Admin") {
  try {
    const event = {
      title: title,
      desc: desc,
