          ...
          <div class="fixed inset-0 overflow-y-auto">
            ...
            >
              ...
              >
                ...
                <div v-if="modal.type === 'bookingDetails'" class="px-6 py-4">
                  <div class="text-sm text-text-800 dark:text-text-700 space-y-4">
                    ...
                    <div class="flex items-center p-3 bg-background-100">
                      <div
                        class="bg-primary-100 p-2 rounded-full border-primary-300 mr-3"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                      ...
                      <div>
                        ...
                        <p class="text-text-900 font-medium">
                          {{
                            ...
                            $t("components.modals.common.notAvailable")
                          }}
                        </p>
                      </div>
                    </div>
                    ...
                    >
                      <div
                        class="bg-primary-100 p-2 rounded-full border-primary-300 mr-3 mt-1 shrink-0"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                ...
                <div
                  class="bg-background-100 dark:bg-background-200 px-6 py-4 sm:flex sm:flex-row sm:gap-2"
                >
