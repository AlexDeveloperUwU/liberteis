    ...
    <aside :class="[
      ...
      <nav>
        <ul class="space-y-[0.75rem]">
          <li v-for="(item, index) in menuItems" :key="index" class="bg-gray-800 p-3 rounded-md border border-gray-700 hover:border-gray-500 transition-colors duration-200">
...
/* Se eliminan las clases relacionadas con la animación del texto al colapsar */
</style>
